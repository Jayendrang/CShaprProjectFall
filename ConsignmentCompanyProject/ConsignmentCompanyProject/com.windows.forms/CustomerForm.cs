        ...
        private void buttonDynamicButton_Click(object sender, EventArgs e)
        {
            if (radioButtonAddNewVendor.Checked == true)
            {
                ...
                try
                {
                    ...
                    if (result == true)
                    {
                        MessageBox.Show("New Vendor successfully", "CUSTOMER", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
                ...
                {
                    MessageBox.Show("Provide Appropriate values", "CUSTOMER", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            else if (radioButtonDeleteVendor.Checked == true)
            {
                ...
                if (textBoxCustomerId.Text != null)
                {
                    ...
                    if (result == true)
                    {
                        ...
                        MessageBox.Show("Vendor deactivated from system successfully", "CUSTOMER", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        clearFormContent();

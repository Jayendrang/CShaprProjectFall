...
namespace ConsignmentCompanyProject.windows.forms
{
    public partial class OrderReturnForm : Form
    {
        ...
        private UserInformationProperties _userInformationSession;
        ...
        private void OrderReturnForm_Load(object sender, EventArgs e)
        {
            ...
            //**********TEST
            orderReturnHandler.getCustomerData(_userInformationSession.Vendor_ID);
        ...
        private void buttonCreateReturn_Click(object sender, EventArgs e)
        {
            ...
            {
                orderReturnProperty.Return_Description = textBoxReturnReason.Text.ToUpper();
        ...
        private void fillItineraryDataGrid(string orderID)
        {
            ...
            {
                ++index;
                textBoxOrderId.Text = orderItinerary.Order_Id.ToUpper();
                textBoxVendorName.Text = orderItinerary.Vendor_Id.ToUpper();
        ...
        private OrderReturnProperties getItineraryValues(string productId)
        {
            ...
            foreach (com.app.dataobjects.OrderProperties itineraryDetails in itinerary)
            {
                ...
                {
                    returnOrderProperty.Order_Id = itineraryDetails.Order_Id.ToUpper();
                    returnOrderProperty.Return_Order_Id = textBoxReturnId.Text.ToUpper();
                    returnOrderProperty.Vendor_Id = itineraryDetails.Vendor_Id.ToUpper();
                    //************test
                    returnOrderProperty.User_Id = _userInformationSession.User_Id;
                    returnOrderProperty.Product_Id = itineraryDetails.Product_Id.ToUpper();
                    returnOrderProperty.Product_Type = itineraryDetails.Product_Type.ToUpper();
                    returnOrderProperty.Product_Name = itineraryDetails.Product_Name.ToUpper();
                    ...
                    {
                        returnOrderProperty.Return_Description = textBoxReturnReason.Text.ToUpper();
                    }
                    returnOrderProperty.Return_Status = "NEW RETURN";
                    //***********test
                    returnOrderProperty.Created_By = _userInformationSession.User_Id;
        ...
        private void textBoxCount_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                MessageBox.Show("The count should be less than or equal to Itinerary count".ToUpper());

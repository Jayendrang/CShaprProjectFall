    ...
    public partial class CustomerForm : Form
    {
        ...
        private void buttonSearchVendor_Click(object sender, EventArgs e)
        {
            ...
            if ((!textBoxCustomerId.Text.Equals(null)) && (textBoxCustomerId.Text.Length > 0))
            {
                ...
                textBoxDiscountId.Text = discountValues.Discount_Id;
                    textBoxStatus.Text = fieldValues.Vendor_Status;
                    textBoxCustomerId.ReadOnly = true;
                }else
                {
        ...
        private void buttonDynamicButton_Click(object sender, EventArgs e)
        {
            if (radioButtonAddNewVendor.Checked == true)
            {
                ...
                try
                {
                    newVendorData.Vendor_Id = textBoxCustomerId.Text;
                    newVendorData.Vendor_Name = textBoxCustomerName.Text;
                    ...
                    newVendorData.Vendor_Status = textBoxStatus.Text;
                    //******************* testing
                    //delegate invoked
                    result = addVendor.Invoke(newVendorData, "JaY2234");
                    if (result == true)
                    {
                        MessageBox.Show("New Vendor successfully", "VENDOR", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
                        MessageBox.Show("Please provide the correct vendor details", "VENDOR", MessageBoxButtons.OK, MessageBoxIcon.Question);
                    }
                }
                catch (Exception ex)
                {
            ...
            else if (radioButtonModifyVendor.Checked == true)
            {
                ...
                try
                {
                    ...
                    existingVendorData.Vendor_Name = textBoxCustomerName.Text;
                    existingVendorData.Vendor_Contact = textBoxContact.Text;
                    existingVendorData.Vendor_EMail_Id = textBoxMailId.Text;
                    existingVendorData.Vendor_Address = textBoxAddress.Text;
                    existingVendorData.Vendor_Status = textBoxStatus.Text;
                    //******************* testing
                    //delegate invoked
                    result = modifyVendor.Invoke(existingVendorData, "JaY2234");
                    if (result == true)
                    {
                        MessageBox.Show("Vendor details updated successfully", "VENDOR", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
                        MessageBox.Show("Please provide the correct vendor details", "VENDOR", MessageBoxButtons.OK, MessageBoxIcon.Question);
            ...
            else if (radioButtonDeleteVendor.Checked == true)
            {
                ...
                if (textBoxCustomerId.Text != null)
                {
                    ...
                    //********************* testing
                    //delegate invoked
                    result = deactivateVendor.Invoke(existingVendorData, "JaY2234");
                    if (result == true)
                    {
                        MessageBox.Show("Vendor deactivated from system successfully", "VENDOR", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        clearFormContent();

INSERT INTO DISCOUNT(DISCOUNT_ID,DISCOUNT_RATE,CREATED_BY,CREATED_DATE,MODIFY_BY,MODIFY_DATE) VALUES ('DIS4','3','ADMIN','07/01/2017','ADMIN','07/01/2017');
...
/*RETRIEVEING PRODUCTS FOR INVENTORY FORM */
SELECT PRODUCT.PRODUCT_ID,PRODUCT.PRODUCT_TYPE,PRODUCT.PRODUCT_CURRENT_COUNT, PRODUCT.MINIMUM_COUNT,
 PRODUCT.PRICE_PER_UNIT,MANUFACTURER.MANUFACTURER_NAME,MANUFACTURER_DETAIL FROM PRODUCT INNER JOIN MANUFACTURER ON PRODUCT.MANUFACTURER_ID = MANUFACTURER.MANUFACTURER_ID ORDER BY MANUFACTURER.MANUFACTURER_ID;

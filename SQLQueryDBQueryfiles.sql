...
PRODUCT.PRICE_PER_UNIT,MANUFACTURER.MANUFACTURER_NAME,MANUFACTURER_DETAIL FROM PRODUCT INNER JOIN MANUFACTURER ON PRODUCT.MANUFACTURER_ID = MANUFACTURER.MANUFACTURER_ID ORDER BY MANUFACTURER.MANUFACTURER_NAME;

 /* RETRIEVING VENDOR SPECIFIC ORDERS*/
 INSERT INTO MANUFACTURER VALUES('MAN003','DELL','PC, LAPTOP AND SERVER SUPPLIER','JaY2234','11/12/2016','JaY2234','11/12/2016');
 SELECT * FROM MANUFACTURER;
 
 DELETE FROM 

 INSERT INTO PRODUCT VALUES('PRD004','MICROSOFT','SURFACE LAPTOP 10Inch','MAN002','1000','100','950.00','11/11/2015','JaY2234','JaY2234','11/11/2015');
 
 INSERT INTO PRODUCT VALUES('PRD005','MICROSOFT','SURFACE LAPTOP 13Inch','MAN002','1000','100','1050.00','11/11/2015','JaY2234','JaY2234','11/11/2015');
 
 INSERT INTO PRODUCT VALUES('PRD006','MICROSOFT','SURFACE LAPTOP 15Inch','MAN002','1000','100','1250.00','11/11/2015','JaY2234','JaY2234','11/11/2015');